 ...
 * 
 */
@WebServiceClient(name = "CalculadoraImplService", targetNamespace = "http://ws.calculadora.com/", wsdlLocation = "http://localhost:1515/Calculadora?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULADORAIMPLSERVICE_QNAME = new QName("http://ws.calculadora.com/", "CalculadoraImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:1515/Calculadora?wsdl");
    ...
    public Calculadora getCalculadoraImplPort() {
        return super.getPort(new QName("http://ws.calculadora.com/", "CalculadoraImplPort"), Calculadora.class);
    }
    ...
    public Calculadora getCalculadoraImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.calculadora.com/", "CalculadoraImplPort"), Calculadora.class, features);
    }
