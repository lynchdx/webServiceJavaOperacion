 ...
 * generated in the com.calculadora.ws package. 
...
public class ObjectFactory {
    ...
    private final static QName _OperacionResponse_QNAME = new QName("http://ws.calculadora.com/", "operacionResponse");
    private final static QName _Operacion_QNAME = new QName("http://ws.calculadora.com/", "operacion");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.calculadora.ws
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.calculadora.com/", name = "operacionResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.calculadora.com/", name = "operacion")
